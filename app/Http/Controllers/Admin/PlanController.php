        ...
        if ($request->ajax()) {
            return DataTables::of($plans)
                ...
                ->addColumn('plan_price', function ($plan) use ($symbol) {
                    // Price
                    $price = $plan->plan_price != 0 ? formatCurrency($plan->plan_price) : __('Free');
                ...
                ->addColumn('action', function ($plan) {
                    $actions = '
                        <a class="btn small-btn dropdown-toggle align-text-top" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ' . __('Actions') . '
                        </a>
