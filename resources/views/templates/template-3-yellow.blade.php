                                                    ...
                                                    <div class="flex flex-col justify-between bg-white shadow rounded-lg overflow-hidden h-350 p-2">
                                                        ...
                                                        @if ($enquiry_button && $whatsAppNumberExists && $service_detail->enable_enquiry == 'Enabled')
                                                            <div class="mt-4">
                                                                ...
                                                                class="block w-full py-2 bg-yellow-500 hover:bg-yellow-600 text-white text-sm text-center rounded"
                                                                target="_blank">
                                                        ...
                                                        <div class="flex flex-col bg-white shadow rounded-lg overflow-hidden h-400 p-4">
                                                            ...
                                                            <div class="flex-1 mt-4">
                                                                ...
                                                                <p class="text-sm text-gray-700 font-bold text-left">
                                                                    ...
                                                                    <span id="{{ $product_detail->product_id }}_price">{{ formatCurrency($product_detail->sales_price) }}</span>
                                                                    @if ($product_detail->sales_price != $product_detail->regular_price)
                                                                        <span class="text-xs line-through text-yellow-500 font-bold ml-1">
                                ...
                                <div class="lg:pb-1 pb-10 px-3">
                                    <div
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a class="text-yellow-500" href="{{ url()->current() }}">
                    ...
                    <div class="bg-white rounded-lg p-6 w-96 max-w-full shadow-lg transform transition-all duration-300"
                        ...
                        <div class="mt-6 space-y-4">
                            <form action="{{ route('check.pwd', $business_card_details->card_id) }}" method="post">
                                ...
                                {{-- Message --}}
                                @if (Session::has('message'))
                                    <div class="flex items-center p-4 my-4 text-sm text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-400"
                                        role="alert">
