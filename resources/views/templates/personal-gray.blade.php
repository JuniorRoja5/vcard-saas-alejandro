                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="px-4 py-6 lg:bg-white lg:shadow rounded">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.basic-appointment', ['section_bg' => 'white', 'bg_color' => 'white', 'btn_color' => 'gray-500', 'text_color' => 'white'])
                        @endif
    ...
    <div
        ...
        <div class="modal-container bg-white w-auto md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <a id="download" onclick="downloadQr('{{ config('app.url') . route('dynamic.card', $business_card_details->card_id, false) }}', 500)" class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-gray-500 hover:bg-gray-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">
