    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                cart_items +=
                    `<p class="text-dark mt-1"><strong> ${jsFormatCurrency(total_price, setDecimalsPlaces, formatType)}</strong></p>`;
                cart_items += `</div>`;
            ...
            if (grandTotal > 0) {
                ...
                cart_items +=
                    `<br><h3 class="pl-4 pt-4 pr-4 font-bold">{{ __('Grand total:') }}  ${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</h3>`;
            }
