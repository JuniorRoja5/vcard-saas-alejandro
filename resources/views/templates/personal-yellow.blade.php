...
<body class="antialiased text-body font-body lg:bg-yellow-500"
            ...
            <div class="flex flex-wrap template-4 -m-2">
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="px-4 py-6 lg:bg-white lg:shadow rounded">
                        <div class="relative {{ $business_card_details->cover_type == 'photo' ? 'pt-40 md:pt-56' : 'pt-10' }} rounded overflow-hidden">

                            @if ($business_card_details->cover_type == 'photo')
                                <img 
                                    class="absolute top-0 left-0 w-full h-52 md:h-64 lg:h-72 object-cover" 
                            ...
                            <div class="relative flex justify-center -mt-8">
                                <img 
                                    class="{{ $business_card_details->cover_type == 'photo' ? 'w-40 h-40' : 'w-48 h-48' }} rounded-full border-4 border-white object-cover object-center shadow-md" 
                            ...
                            <div class="text-center mt-4 relative z-20">
                                <h2 class="font-medium text-xl">{{ $business_card_details->title }}</h2>
                                <p class="text-sm text-gray-500">{{ $card_details->sub_title }}</p>
                            </div>

                            @if ($business_card_details->description != null)
                                <div class="mb-6 mt-4 text-center px-4">
                            ...
                            <!-- Actions -->
                            <div class="flex flex-wrap justify-center gap-4 px-4 mt-4">
                                <!-- QR Code -->
                                <a
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.basic-appointment', ['section_bg' => 'white', 'bg_color' => 'white', 'btn_color' => 'yellow-500', 'text_color' => 'white'])
                        @endif
    ...
    {{-- Send vCard --}}
    <div
        class="send-modal opacity-0 transition duration-300 ease-in-out pointer-events-none fixed w-full h-full top-0 left-0 flex items-center justify-center z-50">
    ...
    <div
        ...
        <div class="modal-container bg-white w-auto md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <a id="download" onclick="downloadQr('{{ config('app.url') . route('dynamic.card', $business_card_details->card_id, false) }}', 500)" class="mt-3 cursor-pointer w-full flex justify-center items-center content-center bg-yellow-500 hover:bg-yellow-600 shadow-lg hover:shadow-lg h-8 w-8 rounded fill-current text-white qr-code-download">
