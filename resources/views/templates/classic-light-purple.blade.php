                ...
                <div id="profile" class="leading-tight min-h-screen p-1">
                    ...
                    <div
                                            ...
                                            <div class="w-full mb-1 mt-1 justify-between items-center">
                                                <div>
                                                    ...
                                                    <span id="{{ $product_detail->product_id }}_subtitle"
                                                        class="text-xs text-dark">{{ $product_detail->product_description }}</span>
                                                </div>
                                            </div>
                        ...
                        @if (count($payment_details) > 0)
                            ...
                            <div class="w-full px-5 align-middle py-4 border-b">
                                <p class="font-semibold text-lg">{{ __('Payment Details') }}</p>
                            </div>
                                        ...
                                        <div class="flex items-center w-full px-5 ">
                                            ...
                                            @if ($payment->type != 'upi' && $payment->type != 'image')
                                                <div class="w-3/4 mx-5 my-6">
                                                    <p class="font-semibold break-word text-lg">
                                                        {{ $payment->label }}</p>
                                                    <p class="font-medium pt-1 break-word text-base">
                                            ...
                                            @if ($payment->type == 'upi')
                                                <div class="w-3/4 mx-5 my-6">
                                                    <p class="font-semibold break-word text-lg mb-2">
                                                        {{ $payment->label }}</p>
                                                    <canvas class="upi_qr"></canvas>
                                                    <p
                                                        class="font-medium pt-1 break-word text-base upi_id hidden">
                                                        {{ $payment->content }}</p>
                                                </div>
                                            @endif
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-purple-800" href="{{ url()->current() }}">
