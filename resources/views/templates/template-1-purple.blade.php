                                        ...
                                        <div class="swiper-wrapper mb-3">
                                            @foreach ($service_details as $service_detail)
                                                <div class="swiper-slide pb-4">
                                                    <div class="flex flex-col justify-between rounded-lg overflow-hidden h-350">
                                                        <!-- Image -->
                                                        ...
                                                        <div class="flex-1 mt-4">
                                                            {{-- Service Name --}}
                                                            <h3 class="text-xl font-semibold mb-1 service-name">
                                                        ...
                                                        @if ($enquiry_button && $whatsAppNumberExists && $service_detail->enable_enquiry == 'Enabled')
                                                            <div class="mt-4">
                                                                ...
                                                                class="block w-full p-3 bg-purple-500 hover:bg-purple-600 text-white text-sm text-center rounded"
                                                                target="_blank">
                                        ...
                                        <div class="swiper products">
                                            <div class="swiper-wrapper mb-3">
                                                @foreach ($product_details as $product_detail)
                                                    <div class="swiper-slide pb-4">
                                                        <div class="flex flex-col rounded-lg overflow-hidden h-400 p-2">
                                                            <!-- Product Image -->
                                                            ...
                                                            <div class="flex-1 mt-4">
                                                                ...
                                                                <p class="text-sm text-gray-700 font-bold text-left">
                                                                    ...
                                                                    @if ($product_detail->sales_price != $product_detail->regular_price)
                                                                        <span class="text-xs line-through text-gray-500 font-bold ml-1">
                                ...
                                <div class="pb-1">
                                    <div
                                        ...
                                        <div class="mt-2">
                                            ...
                                            <a class="text-purple-500" href="{{ url()->current() }}">
