                ...
                <div class="w-full lg:w-1/2">
                    ...
                    <div class="px-4 py-6 lg:bg-white lg:shadow rounded">
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            @include('templates.includes.basic-appointment', ['section_bg' => 'white', 'bg_color' => 'white', 'btn_color' => 'green-500', 'text_color' => 'white'])
                        @endif
