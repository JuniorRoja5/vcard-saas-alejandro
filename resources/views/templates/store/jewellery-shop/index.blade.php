...
<head>
    ...
    <!-- Tile for Win8 -->
    <meta name="msapplication-TileColor" content="gold">
    ...
    <style>
        ...
        .rotate-loop {
            animation: spinLoop 16s linear infinite;
        }

        .rotate-loop-reverse {
            animation: spinLoop2 16s linear infinite;
        }
    </style>
...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #FFF2EB;">
        ...
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->
                    @include('templates.store.jewellery-shop.includes.header', [
                        'bg_color' => 'gold',
                        'badge_color' => 'danger',
                    ])
                    ...
                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-gold p-3">{{ $business_card_details->sub_title }}
                            </h3>
                        </div>
                            ...
                            <swiper-container space-between="20" class="mySwiper" autoplay-delay="2500"
                                ...
                                @if (is_array(json_decode($business_card_details->cover)) == true)
                                    @foreach (json_decode($business_card_details->cover) as $cover)
                                        <swiper-slide>
                                            <img class="rounded-jewellery-shop w-100 h-100 object-fit-cover"
                        ...
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity-gold rounded-jewellery-shop col-md-3 my-3 px-3' : 'col-md-12 my-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute rotate-loop"
                                        src="{{ asset('img/templates/jewellery-shop/18.png') }}"
                                        style="
                                           width: 110px;
                                            height: 110px;
                                            left: -50px;
                                            ...
                                            opacity: 0.8;
                                        " />
                                    <img class="position-absolute rotate-loop-reverse"
                                        src="{{ asset('img/templates/jewellery-shop/18.png') }}"
                                        style="
                                           width: 110px;
                                            height: 110px;
                                ...
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit" class="btn btn-gold w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-gold bottom-bar-custom">
                                    </div>
                                </h2>
                                ...
                                <h2
                                    ...
                                    {{ __('Categories') }}
                                    <div class="position-absolute start-0 bg-gold bottom-bar2"></div>
                                </h2>
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a
                                                ...
                                                <div class="card rounded-jewellery-shop">
                                                    <div
                                                        ...
                                                        <div class="ratio ratio-1x1">
                                                            <img src="{{ url($category->thumbnail) }}"
                                                                class="object-cover rounded-jewellery-shop w-100"
                                        ...
                                        <a href="{{ url()->current() }}" class="text-decoration-none">
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('img/templates/all-categories.png') }}"
                                                    alt="All" class="rounded-jewellery-shop"
                                                    style="width: 40px; height: 40px; object-fit: cover;">
                                                <h3 class="mb-0 text-secondary fs-3">{{ __('All') }}</h3>
                                            </div>
                                        </a>
                                    </div>
                                    <!-- Foreach -->
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-dark' : 'text-secondary' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <div class="mt-3 {{ request('category') ? 'col-md-9 ps-lg-4' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute"
                                        src="{{ asset('img/templates/jewellery-shop/5.png') }}"
                                        style="
                                            width: 140px;
                                            height: 140px;
                                            right: -68px;
                                    ...
                                    <img class="position-absolute"
                                        src="{{ asset('img/templates/jewellery-shop/1.png') }}"
                                        style="
                                           width: 140px;
                                            height: 140px;
                                            left: -55px;
                                ...
                                <div class="row align-items-center {{ request('category') ? '' : 'd-none' }}">
                                    ...
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-gold w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                    ...
                                    <div class="row">
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block img-fluid object-fit-cover w-100 rounded-jewellery-shop"
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    ...
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-gold text-white p-custom fs-1 rounded-jewellery-shop"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'gold']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'gold']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
                                        ...
                                        <ul class="list-inline list-inline-dots mb-0">
                                            <li class="list-inline-item"><a href="{{ $shareComponent['facebook'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-facebook-filled text-gold"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['twitter'] }}"
                                                    class="link-light"><i
                                                        class="ti ti-brand-twitter-filled text-gold"></i></a>
                                            </li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['linkedin'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-linkedin text-gold"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['telegram'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-telegram text-gold"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['whatsapp'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-whatsapp text-gold"></i></a></li>
                                        </ul>
                                    </div>
                                    <!-- Copyright -->
                                        ...
                                        <ul class="list-inline list-inline-dots mb-0">
                                            @if ($plan_details['hide_branding'] == 1)
                                                <li class="list-inline-item">
                                                    {{ __('Copyright') }} &copy; <span id="year"></span> <a
                                                        ...
                                                        class="link-light text-gold"><strong>{{ $card_details->title }}</strong></a>.
                                            ...
                                            @else
                                                <li class="list-inline-item">
                                                    {{ __('Copyright') }} &copy; <span id="year"></span> <a
                                                        href="{{ url($business_card_details->card_url) }}"
                                                        class="link-light text-gold"><strong>{{ config('app.name') }}</strong></a>.
                                                    {{ __('All rights reserved.') }}
                                                </li>
                                            @endif
                                        </ul>
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'gold', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-gold d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-gold fs-2 btn-effect" id="place-order"
                        ...
                        <div class="modal-body">
                            <form action="{{ route('subscribe.store.newsletter') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Button -->
                                    <div class="col-4">
                                        <button type="submit" class="btn btn-gold w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank" class="btn btn-gold w-100">{{ __($button_text) }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-jewellery-shop object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-gold">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-gold d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-gold d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
