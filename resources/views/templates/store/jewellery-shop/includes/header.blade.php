<header class="navbar navbar-expand d-print-none p-2">
    <div class="container-xl mx-auto">
        ...
        <div class="navbar-nav flex-row order-md-last">
            {{-- Language switcher --}}
            @include('templates.includes.bs-language-switcher', ['rounded' => 'rounded-jewellery-shop'])
            ...
            <div class="nav-item dropdown">
                <div class="nav-item">
                    <a class="position-relative cursor-pointer btn-effect" data-bs-toggle="offcanvas" href="#offcanvasEnd"
                        ...
                        <i class="ti ti-shopping-bag bg-{{ $bg_color }} text-white p-2 rounded-jewellery-shop"></i>
