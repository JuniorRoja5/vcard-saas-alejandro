                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="ratio ratio-16x9 mb-2">
                                        <img src="{{ url($productImages[0]) }}" id="product_image"
                                            ...
                                            class="w-100 rounded-jewellery-shop object-fit-cover">
                                    </div>
                                        ...
                                        @foreach ($productImages as $productImage)
                                            <swiper-slide>
                                                <div class="product-image-wrapper">
                                                    <img class="img-fluid w-100 h-100 object-fit-cover rounded-jewellery-shop"
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-gold btn-lg w-100 rounded-jewellery-shop fs-2 fw-bold btn-effect">
                            ...
                            <div class="row">
                                <div class="position-relative">
                                    <img class="position-absolute floater-img"
                                        src="{{ asset('img/templates/jewellery-shop/8.png') }}"
                                        style="
                                            width: 120px;
                                            height: 120px;
                                            left: -35px;
