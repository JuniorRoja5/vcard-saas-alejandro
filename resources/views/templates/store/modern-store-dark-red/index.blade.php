...
<body data-bs-theme="dark"
    ...
    <div id="wrapper" class="page">
                            ...
                            <div
                                ...
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit"
                                            class="btn btn-red w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-red' : 'text-white' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'red', 'bg' => 'dark'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-red d-flex" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-red fs-2" id="place-order"
