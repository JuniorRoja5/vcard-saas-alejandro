...
<head>
    ...
    <style>
        ...
        .rounded-modern, textarea, .alert, .badge {
            border-radius: 0px !important;
        }
...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #FFDCDC;">
                ...
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <div class="pt-6 px-3 px-lg-4 mt-6">
                        <div class="mt-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="ratio ratio-16x9 mb-2">
                                        <img src="{{ url($productImages[0]) }}" id="product_image"
                                            ...
                                            class="w-100 rounded-modern object-fit-cover">
                                    </div>
                                        ...
                                        @foreach ($productImages as $productImage)
                                            <swiper-slide>
                                                <div class="product-image-wrapper">
                                                    <img class="img-fluid w-100 h-100 object-fit-cover rounded-modern"
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-dark btn-lg w-100 rounded-modern fs-2 fw-bold btn-effect">
                            ...
                            <div class="row">
                                <h2 class="head pt-4 pb-5 text-center position-relative fs-custom fw-bold">
                                    {{ __('Related Products') }}
                                    <div
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'dark', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
