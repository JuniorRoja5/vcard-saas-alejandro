        ...
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <!-- Product Details -->
                    <div class="pt-6 px-3 px-lg-4 mt-6">
                        <div class="mt-4">
                            <!-- Product Details -->
                            <div class="row">
                                <!-- Product Image -->
                                <div class="col-md-6">
                                    ...
                                    <div class="ratio ratio-16x9 mb-2">
                                        <img src="{{ url($productImages[0]) }}" id="product_image"
                                            ...
                                            class="w-100 rounded-cosmetics object-fit-cover">
                                    </div>
                                        ...
                                        @foreach ($productImages as $productImage)
                                            <swiper-slide>
                                                <div class="product-image-wrapper">
                                                    <img class="img-fluid w-100 h-100 object-fit-cover rounded-cosmetics"
                                ...
                                <div class="col-md-6 pt-4 p-lg-3">
                                    <!-- Product Name -->
                                    <h3 class="fs-custom fw-bold" id="product_name">
                                        {{ $product_details->product_name }}</h3>
                                    <!-- Product Subtitle -->
                                    <p class="text-dark fs-3 text-muted">
                                    ...
                                    @if ($product_details->product_status == 'instock')
                                        <div class="col-12 col-md-6">
                                            <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                class="cursor-pointer btn btn-rose btn-lg w-100 rounded-cosmetics fs-2 fw-bold btn-effect">
                            ...
                            <div class="row">
                                <div class="position-relative">
                                    <img class="position-absolute floater-img"
                                        src="{{ asset('img/templates/cosmetics/6.png') }}"
                                        style="
                                            width: 120px;
                                            height: 120px;
                                            right: -30px;
                                ...
                                <h2 class="head py-6 text-center position-relative fs-custom fw-bold">
                                    {{ __('Related Products') }}
                                    <div
