        ...
        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    ...
                    <!-- Categories -->
                    <div class="col-md-12 mb-3 mt-7 px-3 px-lg-4">
                        <div class="position-relative">
                            <img class="position-absolute floater-img"
                                src="{{ asset('img/templates/cosmetics/4.png') }}"
                                style="
                                    width: 140px;
                                    height: 140px;
                                    right: -10px;
                        ...
                        <h2 class="head pt-4 pb-6 text-center position-relative fs-custom fw-bold">
                            {{ __('Categories') }}
                            <div class="position-absolute start-50 translate-middle-x bg-rose bottom-bar-custom">
                            </div>
                        </h2>
