...
<head>
    ...
    <meta name="theme-color" content="rose" />
    ...
    <!-- Tile for Win8 -->
    <meta name="msapplication-TileColor" content="rose">
    ...
    {{-- Font --}}
    <link href="https://fonts.googleapis.com/css2?family=Figtree:wght@100;200;300;400;500;600;700;800;900&display=swap"
        rel="stylesheet">
...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    {{-- Page --}}
    <div id="wrapper" class="page m-0 min-h-screen" style="background-color: #FFDCDC;">

        <div class="page-wrapper m-0 p-0">
            <div class="page-body m-0 p-0">
                <div class="container-xl card rounded-0 p-0 overflow-hidden" style="min-height: 100vh;">
                    <!-- Navbar -->
                    @include('templates.store.cosmetics.includes.header', [
                        'bg_color' => 'rose',
                        'badge_color' => 'blue',
                    ])

                    <div class="row mt-7 px-3 px-lg-4">
                        {{-- Greeting message --}}
                        <div class="col-md-12">
                            <h3 class="alert alert-important alert-rose p-3">{{ $business_card_details->sub_title }}
                            </h3>
                        </div>
                            ...
                            <swiper-container space-between="20" class="mySwiper" autoplay-delay="2500"
                                ...
                                @if (is_array(json_decode($business_card_details->cover)) == true)
                                    @foreach (json_decode($business_card_details->cover) as $cover)
                                        <swiper-slide>
                                            <img class="rounded-cosmetics w-100 h-100 object-fit-cover"
                        ...
                        <div class="row {{ request('category') ? 'ps-2 ps-lg-3' : '' }}">
                            <!-- Categories -->
                            <div
                                class="{{ request('category') ? 'bg-opacity rounded-cosmetics col-md-3 my-3 px-3' : 'col-md-12 my-3' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute" src="{{ asset('img/templates/cosmetics/3.png') }}"
                                        style="width: 140px; height: 140px; left: -40px; opacity: 0.4; top: -12px; transform: rotate(34deg);" />
                                </div>
                                {{-- Filter --}}
                                <form class="row pt-3 {{ request('category') ? '' : 'd-none' }}" method="GET"
                                    ...
                                    <div class="col-md-4 mt-2 mt-md-0">
                                        <button type="submit" class="btn btn-rose w-100">{{ __('Filter') }}</button>
                                    </div>
                                </form>

                                <h2
                                    class="head pt-5 pb-6 text-center position-relative fs-custom fw-bold {{ request('category') ? 'd-none' : '' }}">
                                    {{ __('Categories') }}
                                    <div
                                        class="position-absolute start-50 translate-middle-x bg-rose bottom-bar-custom">
                                    </div>
                                </h2>

                                <h2
                                    class="head pt-4 pb-5 text-start position-relative fs-custom fw-bold {{ request('category') ? '' : 'd-none' }}">
                                    {{ __('Categories') }}
                                    <div class="position-absolute start-0 bg-rose bottom-bar2"></div>
                                </h2>
                                    ...
                                    @foreach ($categories as $category)
                                        <swiper-slide class="cursor-pointer">
                                            <a
                                                ...
                                                <div class="card rounded-cosmetics">
                                                    <div
                                                        ...
                                                        <div class="ratio ratio-1x1">
                                                            <img src="{{ url($category->thumbnail) }}"
                                                                class="object-cover rounded-cosmetics w-100"
                                                                alt="{{ $category->category_name }}" />
                                                        </div>
                                                        <!-- Category Name -->                                                        
                                                        <h3 class="mt-2 mb-0 fs-3 text-truncate single-product"
                                        ...
                                        <a href="{{ url()->current() }}" class="text-decoration-none">
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="{{ asset('img/templates/all-categories.png') }}"
                                                    alt="All" class="rounded-cosmetics"
                                                    style="width: 40px; height: 40px; object-fit: cover;">
                                                <h3 class="mb-0 text-dark fs-3">{{ __('All') }}</h3>
                                            </div>
                                        </a>
                                    </div>
                                    <!-- Foreach -->
                                            ...
                                            <a
                                                ...
                                                <div class="text-decoration-none">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Category Name -->
                                                        <h3
                                                            class="mb-0 fs-3 {{ request('category') == $category_name ? 'text-rose' : 'text-dark' }}">
                                                            {{ __($category->category_name) }}
                                                        </h3>
                                                    </div>
                                                </div>
                            ...
                            <!-- Products -->
                            <div class="mt-3 {{ request('category') ? 'col-md-9 ps-lg-4' : 'col-md-12' }}">
                                <div class="position-relative {{ request('category') ? 'd-none' : '' }}">
                                    <img class="position-absolute" src="{{ asset('img/templates/cosmetics/1.png') }}"
                                        style="
                                            width: 140px;
                                            height: 140px;
                                            right: -40px;
                                ...
                                <div class="position-relative {{ request('category') ? '' : 'd-none' }}">
                                    <img class="position-absolute floater-img"
                                        src="{{ asset('img/templates/cosmetics/1.png') }}"
                                        style="
                                            width: 120px;
                                            height: 120px;
                                            right: -40px;
                                ...
                                <div class="row align-items-center {{ request('category') ? '' : 'd-none' }}">
                                    ...
                                    <form class="row col-md-8" method="GET" action="{{ url()->current() }}">
                                        ...
                                        <div class="col-3">
                                            <button type="submit"
                                                class="btn btn-rose w-100">{{ __('Search') }}</button>
                                        </div>
                                    </form>
                                ...
                                @if (count($products) > 0)
                                    <div class="row">
                                        ...
                                        @foreach ($products as $product)
                                            <div
                                                class="col-12 {{ request('category') ? 'col-md-4' : 'col-md-3' }} mb-3">
                                                <div class="card d-flex flex-column p-3">
                                                    <div class="d-flex flex-column">
                                                        ...
                                                        <a
                                                                ...
                                                                <div class="carousel-inner">
                                                                    @foreach ($productImages as $productImage)
                                                                        <div
                                                                            ...
                                                                            <img class="d-block img-fluid object-fit-cover w-100 rounded-cosmetics"
                                                            ...
                                                            <!-- Product Subtitle -->
                                                            <p class="text-secondary mb-2 text-truncate">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            @if ($product->product_status == 'instock')
                                                                <a onclick="addToCart('{{ $product->product_id }}')"
                                                                    class="cursor-pointer btn-effect">
                                                                    <i
                                                                        class="ti ti-shopping-bag-plus bg-rose text-white p-custom fs-1 rounded-cosmetics"></i>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 my-3">
                                            @if (request()->has('category'))
                                                {{ $products->appends(request()->except('page'))->links('vendor.pagination.store', ['color' => 'rose']) }}
                                            @else
                                                {{ $products->links('vendor.pagination.store', ['color' => 'rose']) }}
                                            @endif
                                        </div>
                                    </div>
                                @else
                                        ...
                                        <ul class="list-inline list-inline-dots mb-0">
                                            <li class="list-inline-item"><a href="{{ $shareComponent['facebook'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-facebook-filled text-rose"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['twitter'] }}"
                                                    class="link-light"><i
                                                        class="ti ti-brand-twitter-filled text-rose"></i></a>
                                            </li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['linkedin'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-linkedin text-rose"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['telegram'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-telegram text-rose"></i></a></li>
                                            <li class="list-inline-item"><a href="{{ $shareComponent['whatsapp'] }}"
                                                    target="_blank" class="link-light"><i
                                                        class="ti ti-brand-whatsapp text-rose"></i></a></li>
                                        </ul>
                                    </div>
                                    <!-- Copyright -->
                                        ...
                                        <ul class="list-inline list-inline-dots mb-0">
                                            @if ($plan_details['hide_branding'] == 1)
                                                <li class="list-inline-item">
                                                    {{ __('Copyright') }} &copy; <span id="year"></span> <a
                                                        ...
                                                        class="link-light text-rose"><strong>{{ $card_details->title }}</strong></a>.
                                            ...
                                            @else
                                                <li class="list-inline-item">
                                                    {{ __('Copyright') }} &copy; <span id="year"></span> <a
                                                        href="{{ url($business_card_details->card_url) }}"
                                                        class="link-light text-rose"><strong>{{ config('app.name') }}</strong></a>.
                                                    {{ __('All rights reserved.') }}
                                                </li>
                                            @endif
                                        </ul>
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'rose', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-rose d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer border-top">
            ...
            <!-- Place Order -->
            <a class="btn btn-rose fs-2 btn-effect" id="place-order"
                        ...
                        <div class="modal-body">
                            <form action="{{ route('subscribe.store.newsletter') }}" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Button -->
                                    <div class="col-4">
                                        <button type="submit" class="btn btn-rose w-100">{{ __('Subscribe') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <div class="d-flex justify-content-center align-items-center">
                                    <a href="{{ $button_url }}" target="_blank" class="btn btn-rose w-100">{{ __($button_text) }}</a>
                                </div>
    ...
    <script>
        ...
        function updateList() {
            ...
            cart.forEach((item, index) => {
                ...
                <div class="me-3 flex-shrink-0" style="width: 100px; height: 100px;">
                    <img src="${item.product_image}" class="img-fluid rounded-cosmetics object-fit-cover h-100 w-100" alt="${item.product_name}" />
                </div>`;
            ...
            if (grandTotal > 0) {
                ...
                $("#cart-pricing").html(
                    `<h3 class="font-bold fs-2 d-flex justify-content-between"><span>{{ __('Grand total') }}</span><span class="text-rose">${jsFormatCurrency(grandTotal, setDecimalsPlaces, formatType)}</span></h3>`
                );
            } else {
                $("#cart-pricing").html(``);
            }
        ...
        function updateBadge() {
            ...
            if (badgeCount > 0) {
                ...
                $("#place-order").show().attr("class", "btn btn-rose d-flex");
            } else {
                $("#place-order").hide().attr("class", "btn btn-rose d-none");
                $("#badge").hide();
                $("#empty-cart").show();
            }
        }
