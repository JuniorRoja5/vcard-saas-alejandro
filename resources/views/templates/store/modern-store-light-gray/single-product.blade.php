...
<body dir="{{ App::isLocale('ar') || App::isLocale('ur') || App::isLocale('he') ? 'rtl' : 'ltr' }}">
    ...
    <div id="wrapper" class="page">
                            ...
                            <div class="card-body p-3 p-lg-4">
                                        ...
                                        @if ($product_details->product_status == 'instock')
                                            <div class="col-12 col-md-6">
                                                <a onclick="addToCart('{{ $product_details->product_id }}')"
                                                    class="cursor-pointer btn btn-secondary btn-lg w-100 radius-img fs-2 fw-bold btn-effect">
                                ...
                                <div class="row">
                                    <h2 class="position-relative fs-custom fw-bold pt-6 pb-5">
                                        {{ __('Related Products') }}
                                        <div class="position-absolute bottom-bar2 bg-secondary">
                                        </div>
                                    </h2>
                                    <div class="col-md-12">
                                        <swiper-container space-between="10" class="mySwiper" autoplay-delay="2500"
        ...
        <!-- Bottom Navbar -->
        @include('templates.includes.bottom-bar', ['color' => 'secondary', 'bg' => 'light'])
        <!-- End Bottom Navbar -->
    </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEnd" aria-labelledby="offcanvasEndLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div id="empty-cart" class="p-3">
                ...
                <!-- Start Shopping -->
                <a class="btn btn-secondary d-flex btn-effect" data-bs-dismiss="offcanvas"
        ...
        <div class="offcanvas-footer">
            ...
            <!-- Place Order -->
            <a class="btn btn-secondary fs-2 btn-effect" id="place-order"
