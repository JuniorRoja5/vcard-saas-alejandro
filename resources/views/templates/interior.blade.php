...
<head>
    ...
    <!-- Tailwind CSS -->
    <link rel="stylesheet" href="{{ url('templates/css/interior.css') }}">
    {{-- Swiper CSS --}}
...
<body class="bg-teal-100 min-h-screen"
    ...
    <div class="container max-w-2xl mx-auto lg:py-8">
        ...
        @if ($business_card_details->password == null || Session::get('password_protected') == true)
                ...
                <div class="bg-white lg:rounded-2xl shadow-[0_0_4px_rgba(0,0,0,0.1)] overflow-hidden"
                    ...
                    @if ($business_card_details->cover_type == 'none')
                        <div class="lg:h-80 h-60 relative" id="profile">
                            {{-- Cover Image --}}
                            <img src="{{ url('img/templates/interior/banner.png') }}"
                    ...
                    <!-- Profile Info -->
                    <div class="relative px-6 -mt-0.5 pb-28 lg:p-6">

                        <img src="{{ url('img/templates/interior/bg.png') }}"
                            alt="{{ $business_card_details->title }}"
                            class="w-full object-cover absolute top-0.5 -mx-6 z-10" />
                        <!-- Start Profile Info -->
                        ...
                        <div class="flex justify-center">
                            <img src="{{ url($business_card_details->profile) }}"
                                alt="{{ $business_card_details->title }}"
                                class="w-40 h-40 rounded-3xl mt-9 z-20 bg-transparent object-cover border-[2px] border-teal-600" />
                        </div>
                        ...
                        <div class="text-center mt-4 relative -mx-6">
                            ...
                            <div class="relative z-10">
                                {{-- Name --}}
                                <h1 class="lg:text-5xl text-3xl font-medium text-[#121212] head tracking-tighter">
                                    {{ $business_card_details->title }}
                                </h1>
                                {{-- Job Title --}}
                                <p class="text-teal-600 font-bold mt-2 text-md">
                                    {{ $card_details->sub_title }}
                                </p>
                                {{-- About --}}
                                @if (isset($business_card_details->description) || isset($business_card_details->address))
                                    <div class="mt-4 text-base leading-relaxed font-medium px-12 tracking-tight">
                                ...
                                @foreach ($feature_details as $feature)
                                    @if (in_array($feature->type, ['tel', 'address', 'wa', 'instagram']))
                                        ...
                                        @if ($feature->type == 'address')
                                            <a href="#location"
                                                class="bg-teal-600 rounded-2xl flex items-center justify-center w-12 h-12 text-white focus:outline-none focus:ring-2 focus:ring-green-700 z-20 focus:ring-teal-500">
                                                <i class="{{ $feature->icon }} fa-lg text-white"></i>
                                            </a>
                                        @endif
                                        {{-- Phone --}}
                                        @if ($feature->type == 'tel')
                                    ...
                                    <div class="grid grid-cols-1 gap-4 relative">
                                        ...
                                        <div class="mt-8 w-full ">
                                            ...
                                            <a href="https://www.google.com/maps/place/{{ urlencode($feature->content) }}"
                                                target="_blank"
                                                class="px-6 py-4 text-white flex flex-col bg-teal-600 rounded-2xl  justify-center focus:outline-none focus:ring-2 focus:ring-teal-500">
                                                <!-- Font Awesome Icon -->
                        ...
                        @if (!empty($feature_details) && count($feature_details) > 0)
                            @php
                                ...
                                $excludedTypes = ['tel', 'instagram', 'address', 'map', 'iframe', 'youtube'];
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        @foreach ($validFeatures as $feature)
                                            ...
                                            @php
                                                ...
                                                } else { // Changed from else to elseif
                                                    $href = 'https://' . str_replace(['https://', 'http://'], '', $feature->content);
                                                }
                                            @endphp
                                            <!-- {{ $feature->label }} -->
                                            <a href="{{ $href }}" target="_blank"
                                                class="p-4 bg-teal-600 transition-colors rounded-2xl flex flex-col focus:outline-none focus:ring-2 focus:ring-teal-500">
                                                <!-- Font Awesome Icon -->
                                                <i class="{{ $feature->icon }} text-white text-xl mb-1"></i>
                                                <!-- Title -->
                                                <h2 class="text-white text-md font-semibold">{{ $feature->label }}
                                                </h2>
                                                <!-- Description -->
                        ...
                        @if ($appointmentEnabled == true && isset($plan_details['appointment']) == 1)
                            <div class="relative">
                                <img src="{{ url('img/templates/interior/1.png') }}" alt=""
                                    class="w-32 absolute top-[46px] -right-[65px] z-20" />
                                <img src="{{ url('img/templates/interior/2.gif') }}" alt=""
                                    class="w-36 absolute -bottom-[143px] -left-[40px]" />
                                <img src="{{ url('img/templates/interior/2.gif') }}" alt=""
                                    class="w-36 absolute -bottom-[143px] -right-[47px]" />
                                {{-- Check appointment slots in the calendar --}}
                                @if ($plan_details['appointment'] == 1)
                                    @if ($appointment_slots != null)
                                        <h2
                                            class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative head">
                                            <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-teal-600 -mx-6">
                                            </div>
                                            {{ __('Appointment') }}
                                        </h2>
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <input type="text" id="appointment-date"
                                                    class="flatpickr-input md:w-1/2 rounded-2xl w-full px-4 py-3 text-[#121212] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600"
                                                    placeholder="{{ __('Select a date') }}" required />
                                                <!-- Select time in dropdown -->
                                                <select id="time-slot-select" required
                                                    class="md:w-1/2 w-full px-4 py-3 rounded-2xl text-[#121212] bg-white border border-gray-300 focus:outline-none focus:ring-2 focus:ring-teal-600">
                                            ...
                                            <div class="flex justify-center">
                                                <button id="add-slot-button"
                                                    class="w-full p-3 bg-teal-600 rounded-2xl text-[#F8F9FA] text-lg text-center font-semibold focus:outline-none focus:ring-2 focus:ring-teal-500"
                                                ...
                                                @if ($enquiry_button != null)
                                                    @if ($whatsAppNumberExists == true && $whatsAppNumberExists == true && $service_detail->enable_enquiry == 'Enabled')
                                                        <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product/service:') }} {{ $service_detail->service_name }}. {{ __('Please provide more details.') }}"
                                                            target="_blank"
                                                            class="text-white text-center font-semibold mt-4 bg-teal-600 py-2 px-4 rounded-lg">
                                                            {{ __('Enquire') }}
                                                        </a>
                                                    @endif
                                                @endif
                                        ...
                                        <swiper-slide class="p-0.5">
                                            ...
                                            <div
                                                ...
                                                @if (!empty($product_detail->badge))
                                                    <p
                                                        class="absolute top-9 right-9 font-medium text-[#F8F9FA] bg-teal-600 px-4 py-1 rounded-full">
                                                    ...
                                                    <div class="flex flex-col mb-4">
                                                        <div>
                                                            <h4 class="text-[#121212] text-md font-bold">
                                                                {{ __('Price:') }}
                                                                <span
                                                                    class="text-gray-500 font-bold text-base ml-1">
                                                    ...
                                                    @if ($enquiry_button != null)
                                                        @if ($whatsAppNumberExists == true)
                                                            <a href="https://wa.me/{{ $enquiry_button }}?text={{ __('Hi, I am interested in your product:') }} {{ $product_detail->product_name }}. {{ __('Please provide more details.') }}"
                                                                target="_blank"
                                                                class="text-white font-semibold block text-center py-2 px-4 rounded-lg bg-teal-600">
                                                                {{ __('Enquire') }}
                                                            </a>
                                                        @endif
                                                    @endif
                        ...
                        @if (count($galleries_details) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/interior/6.png') }}" alt=""
                                    class="w-40 absolute -top-2 -left-[95px]" />
                                <h2
                                    class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative head">
                                    <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-teal-600 -mx-6"></div>
                                    {{ __('Gallery') }}
                                        ...
                                        @foreach ($galleries_details as $galleries_detail)
                                            <swiper-slide class="p-0.5">
                                                ...
                                                <div
                                                    ...
                                                    <h3
                                                        class="py-3 bg-teal-600 mt-6 text-white text-lg w-full text-center rounded-2xl ">
                                    ...
                                    @foreach ($feature_details as $feature)
                                        @if ($feature->type == 'iframe')
                                            <div class="overflow-hidden rounded-2xl">
                                                ...
                                                {{-- Add Iframe title --}}
                                                @if ($feature->label != null)
                                                    <div class="px-5 py-3 bg-teal-600">
                        ...
                        @if (count($testimonials) > 0)
                            <div class="relative">
                                <img src="{{ url('img/templates/interior/5.png') }}" alt=""
                                ...
                                <swiper-container class="mySwiper" autoplay-delay="2000"
                                    ...
                                    @foreach ($testimonials as $testimonial)
                                        ...
                                        <swiper-slide class="p-1 rounded-2xl">
                                            <div
                                                class="mb-2 flex flex-col items-center justify-center bg-white p-6 shadow-[0_0_3px_rgba(0,0,0,0.1)] text-center rounded-2xl">
                                                {{-- Review --}}
                                                ...
                                                <div>
                                                    ...
                                                    @if ($testimonial->review_subtext)
                                                        <p class="text-teal-600 text-sm text-center ">
                            ...
                            <div class="relative">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div class="flex flex-col rounded-2xl p-4 bg-teal-600">
                                            ...
                                            <h3
                                                class="font-medium text-white {{ $payment->type == 'text' ? 'py-3' : 'pt-3 text-center' }}">
                                                {{ $payment->label }}</h3>
                                    ...
                                    <div class="bg-white rounded-lg py-4">
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                                                @foreach (['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'] as $day)
                                                    <div class="flex items-center space-x-4">
                                                        <!-- Day Icon -->
                                                        <div
                                                            class="flex items-center justify-center w-10 h-10 bg-teal-600 text-[#f8f9fa] rounded-full">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        @else
                                            ...
                                            <div class="flex items-start space-x-4">
                                                <!-- Animated Icon -->
                                                <div
                                                    class="flex items-center justify-center w-12 h-12 bg-teal-100 text-teal-600 rounded-full transform hover:scale-110 transition-transform duration-300 ease-in-out">
                        ...
                        @if ($plan_details['contact_form'] == 1)
                            @if ($business_card_details->enquiry_email != null)
                                <div class="relative">      
                                    <img src="{{ url('img/templates/interior/3.png') }}" alt=""
                                    class="w-40 absolute top-[10px] -left-[80px] z-0" />                             
                                    <h2
                                        class="text-3xl lg:text-4xl font-medium text-[#121212] py-12 text-center relative head">
                                        <div class="absolute bottom-10 left-1/2 h-1 w-14 bg-teal-600 -mx-6"></div>
                                        {{ __('Contact Us') }}
                                    ...
                                    @if (Session::has('message'))
                                        <div class="px-6 py-4 bg-teal-600 shadow-md mb-6">
                                    ...
                                    <form class="w-full max-w-full border px-6 pt-9 shadow-[0_0_4px_rgba(0,0,0,0.1)] pb-6 rounded-2xl bg-white relative z-10"
                                        ...
                                        <div class="grid grid-cols-1 gap-2 lg:gap-6 lg:grid-cols-2">
                                            ...
                                            <div class="grid grid-cols-1 gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="name" placeholder="{{ __('Your Name') }}"
                                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-orange-200 focus:ring-2 focus:ring-orange-600 focus:ring-opacity-50" required />
                                                </div>
                                                {{-- Email --}}
                                                <div>
                                                    <label for="email"
                                            ...
                                            <div class="h-full pb-8">
                                                ...
                                                <textarea name="message" placeholder="{{ __('Your Message') }}"
                                                    class="w-full h-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-600 focus:ring-opacity-50 focus:border-orange-200 resize-none"
                                        ...
                                        <div class="mt-6 relative">
                                            <img src="{{ url('img/templates/interior/7.png') }}" alt=""
                                            class="w-32 absolute top-[84px] -right-[45px]" />
                                            <button type="submit"
                                                class="w-full px-4 py-4 bg-teal-600 text-white text-lg font-semibold rounded-2xl focus:outline-none focus:ring-2 focus:ring-teal-500">
                                                {{ __('Send') }}
                                            </button>
                                        </div>
                                    </form>
                            ...
                            <div class="relative" id="location">
                                ...
                                @foreach ($feature_details as $feature)
                                    @if ($feature->type == 'map')
                                        ...
                                        {{-- Map title --}}
                                        @if ($feature->label != null)
                                            <div class="px-5 py-3 bg-teal-600 rounded-b-2xl">
                            ...
                            <div class="pb-1">
                                <div
                                    ...
                                    <div class="mt-2 text-gray-500">
                                        {{ __('Copyright') }} &copy;
                                        <a class="text-teal-700" href="{{ url()->current() }}">
            ...
            <div
                class="fixed w-full mx-auto left-1/2 bottom-0 px-2 bg-teal-600/60 border border-teal-600 backdrop-blur-md py-4 flex lg:hidden md:hidden transform -translate-x-1/2 z-50">
                <!-- Profile Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <a class="p-3 rounded-full bg-white" href="#profile">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-user text-teal-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Send Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-white" onclick="toggleWhatsAppModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-send text-teal-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M10 14l11 -11" />
                ...
                <div class="flex-1 flex items-center justify-center">
                    <a href="{{ route('download.vCard', $business_card_details->card_id) }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-download text-teal-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Scan Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-white" onclick="toggleScanModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-line-scan text-teal-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <!-- Share Icon -->
                <div class="flex-1 flex items-center justify-center">
                    <button class="p-3 rounded-full bg-white" onclick="shareToggleModal(true)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            class="icon icon-tabler icons-tabler-outline icon-tabler-share text-teal-600 h-6 w-6">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
        ...
        <div id="shareModal"
            ...
            <div class="bg-white rounded-2xl w-full max-w-md p-6 mx-4 space-y-6" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-around text-teal-600">
                ...
                <div class="flex justify-center">
                    <button onclick="copyLink()"
                        class="bg-teal-600 text-white font-bold py-2 px-4 rounded-2xl w-full">
                        {{ __('Copy Link') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white" onclick="event.stopPropagation()">
                ...
                <div class="flex justify-center">
                    <button onclick="sendMessage()"
                        class="bg-teal-600 text-white font-bold py-3 px-4 rounded-2xl w-full focus:outline-none focus:ring-2 focus:ring-teal-500">
                        {{ __('Send') }}
                    </button>
                </div>
            </div>
            ...
            <div class="rounded-2xl w-full max-w-md p-6 mx-4 space-y-6 bg-white qr-modal-overlay"
                ...
                <div class="flex justify-center">
                    <button id="download"
                        ...
                        class="bg-teal-600 font-bold p-3 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                            ...
                            <div class="mt-6 space-y-4">
                                <form action="{{ route('check.pwd', $business_card_details->card_id) }}"
                                    ...
                                    <div class="flex flex-col space-y-4 mt-3">
                                        <button type="submit"
                                            class="bg-teal-600 text-white rounded-2xl px-4 py-2 mt-2 transition duration-300">{{ __('Password') }}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
