                                                    ...
                                                    <div>
                                                        <h4 class="text-[#000000] text-base font-medium">
                                                            ...
                                                            @if ($product_detail->sales_price != $product_detail->regular_price)
                                                                <span
                                                                    class="line-through ml-2 text-gray-600 text-base">
                                ...
                                <div class="grid lg:grid-cols-2 gap-4">
                                    ...
                                    @foreach ($payment_details as $payment)
                                        ...
                                        <div
                                            ...
                                            <h3
                                                class="font-medium text-gray-700 {{ $payment->type == 'text' ? 'py-3' : 'pt-3 text-center' }}">
                                                {{ $payment->label }}</h3>
                        ...
                        @if ($plan_details['hide_branding'] == 1)
                            <div
                                ...
                                <div class="mt-2 text-gray-600">
                                    {{ __('Copyright') }} &copy;
                                    <a class="text-orange-700" href="{{ url()->current() }}">
