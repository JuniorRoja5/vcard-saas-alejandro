...
@php
    ...
    foreach ($themes as $value => $theme) {
        if ($type == 'business') {
            $defaultImage = asset('img/vCards/travel_agency.png');
            $themeId = '588969111148';
        } else if ($type == 'personal') {
            $defaultImage = asset('img/vCards/personal-gray.png');
            $themeId = '588969111021';
        } else if ($type == 'custom') {
            $themeId = '588969111147';
        }
    }
@endphp
                        ...
                        <form action="{{ route('user.save.business.card') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    {{-- Themes --}}
                                    @if ($type != 'custom')
                                        <div class="col-md-4 col-xl-4 mb-5 text-center themes-lightbox border-end">
                                    ...
                                    <div class="{{ $type != 'custom' ? 'col-md-8' : 'col-md-12' }}">
                                        <div class="row">
                                            ...
                                            <input type="hidden" class="form-control" name="type"
                                                value="{{ Request::get('type') ? Request::get('type') : 'business' }}">

                                            <div
                                                class="{{ $type != 'custom' ? 'col-md-6 col-xl-6' : 'col-md-4 col-xl-4' }}">
                                                <div class="mb-3">
                                                    <label class="form-label required"
                                                        for="card_lang">{{ __('Language') }}</label>
                                            ...
                                            <div class="{{ $type != 'custom' ? 'col-md-6 col-xl-6' : 'col-md-4 col-xl-4' }}"
                                                id="cover-type-section">
                                                <div class="mb-3">
                                            ...
                                            {{-- Cover Preview --}}
                                            <div class="{{ $type != 'custom' ? 'col-md-6 col-xl-6' : 'col-md-4 col-xl-4' }} d-none mb-3"
                                                id="coverNone">
                                                <span class="avatar avatar-xl w-100 me-3" id="coverPreview"
                                                    style="background-position: left;"></span>
                                            </div>
                                            ...
                                            <div class="{{ $type != 'custom' ? 'col-md-6 col-xl-6' : 'col-md-4 col-xl-4' }} d-none mb-3"
                                                ...
                                                <span class="avatar avatar-xl w-100 me-3" id="logoPreview"
                                                    style="background-size: contain; background-position: left;"></span>
                                            </div>
                                        ...
                                        <div class="col-md-12 col-xl-12 my-1 text-end">
                                            <div class="mb-3">
        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <div id="status_message" class="text-muted">{{ __('Cover video not supported for this theme') }}
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                function updateAspectRatio() {
                    if (coverThemeId === "588969111148" || coverThemeId === "588969111146" || coverThemeId === "588969111145" || coverThemeId ===
                        "588969111144" || coverThemeId === "588969111143" || coverThemeId === "588969111142" ||
                        coverThemeId === "588969111141" || coverThemeId === "588969111140" || coverThemeId ===
                        "588969111139" || coverThemeId === "588969111138" || coverThemeId === "588969111137" ||
                        coverThemeId === "588969111136" || coverThemeId === "588969111135" || coverThemeId ===
                        "588969111134" || coverThemeId === "588969111133" || coverThemeId === "588969111132" ||
                        coverThemeId === "588969111131" || coverThemeId === "588969111130" || coverThemeId ===
                        "588969111129" || coverThemeId === "588969111128" || coverThemeId === '588969111127' ||
                        coverThemeId === '588969111125' || coverThemeId === '588969111126') {
