...
<div class="basic-info-tab">
    ...
    <div class="tab-header mb-4">
        <div class="d-flex align-items-center justify-content-between">
            <div>
                <h3 class="tab-title">⚙️ Basic Information</h3>
            ...
            <div class="col-lg-4">
                <div class="theme-selector-card">
                    <div class="theme-header">
                        <h5 class="theme-title">🎨 Choose Your Theme</h5>
                            ...
                            <div class="mb-3" id="coverChooser">
                                ...
                                <div class="upload-buttons-row">
                                    ...
                                    <div class="upload-option">
                                        ...
                                        <input type="hidden" class="form-control" name="cover" value="default-cover.png">
                                    </div>
                                </div>
                            </div>
                        </div>
