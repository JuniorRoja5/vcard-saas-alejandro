                ...
                <div class="row row-deck row-cards mb-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">{{ __('Total Storage') }}</div>
                                </div>
                                <div class="h1 mb-3">{{ $totalStorage }} {{ __('MB') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">{{ __('Used Storage') }}</div>
                                </div>
                                <div class="h1 mb-3">{{ $usedStorage }} {{ __('MB') }}</div>
                                <div class="progress progress-md">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger" style="width: {{ $usedStoragePercentage }}%"
                                        role="progressbar" aria-valuenow="{{ $usedStorage }}" aria-valuemin="0"
                                        aria-valuemax="100" aria-label="{{ $usedStoragePercentage }}% Complete">
                                        <span class="visually-hidden">{{ $usedStoragePercentage }}% Complete</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-3">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div class="subheader">{{ __('Available Storage') }}</div>
                                </div>
                                <div class="h1 mb-3">{{ $availableStorage }} {{ __('MB') }}</div>
                                <div class="progress progress-md">
                                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" style="width: {{ $availableStoragePercentage }}%"
                                        role="progressbar" aria-valuenow="{{ $availableStorage }}" aria-valuemin="0"
                                        aria-valuemax="100" aria-label="{{ $availableStoragePercentage }}% Complete">
                                        <span class="visually-hidden">{{ $availableStoragePercentage }}% Complete</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card" id="showPagination">
                <div class="card-footer d-flex align-items-center" id="paginationLinks">
                    <p class="m-0 text-secondary">{{ __('Showing') }} <span id="paginationStartIndex"></span>
                        {{ __('to') }} <span id="paginationEndIndex"></span> {{ __('of') }} <span
                            id="paginationTotalCount"></span> {{ __('results') }}</p>
                    ...
                    <div class="col-sm-3 col-lg-4 mb-3">
                        <div class="card">
                            <div class="img-responsive card-img-top"
                                style="background-image: url(${media.base_url}${media.media_url}); border-radius: 16px 16px 0 0;">
                            </div>
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <div class="fw-bold text-truncate">${currentUserName}</div>
                                        <div class="text-secondary">${media.formatted_created_at}</div>
                                    </div>
                                    <div class="ms-auto d-flex gap-2">
                                        <a href="#" class="btn btn-white" data-bs-toggle="tooltip" title="View">
                                        ...
                                        <a href="#" class="btn btn-danger btn-icon" onclick="deleteMedia('${media.media_id}')" data-bs-toggle="tooltip" title="Delete">
