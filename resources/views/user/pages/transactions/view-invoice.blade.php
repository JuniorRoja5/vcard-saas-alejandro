                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <h5><strong>{{ __('Balance Due') }}</strong>: {{ formatCurrency(0.00) }}</h5>
                            </div>
                        </div>
                        ...
                        <table class="table table-borderless border">
                            ...
                            <tbody>
                                <tr class="fw-bold">
                                    <td>{{ __($planDetails->plan_name) }} - {{ formatCurrency($planDetails->plan_price) }}/{{ $term }}</td>
                                    <td class="text-end">1</td>
                                    <td class="text-end">{{ formatCurrency($planDetails->plan_price) }}</td>
                                    <td class="text-end">{{ formatCurrency($planDetails->plan_price) }}</td>
                                </tr>
                            </tbody>
                            <tfoot class="border-top fw-bold">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ formatCurrency($transaction->billing_details['subtotal']) }}</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">{{ formatCurrency($transaction->billing_details['tax_amount']) }}</td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="font-weight-bold text-end">
                                        - {{ formatCurrency($transaction->billing_details['discounted_price']) }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-end"><strong>{{ formatCurrency($transaction->billing_details['invoice_amount']) }}</strong></td>
                                </tr>

                                {{-- Amount Paid --}}
                                <tr>
                                    <td colspan="3" class="text-end">{{ __('Amount Paid') }}</td>
                                    <td class="text-end">{{ formatCurrency($transaction->billing_details['invoice_amount']) }}</td>
                                </tr>
                            </tfoot>
                        </table>
