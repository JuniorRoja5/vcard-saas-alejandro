                    ...
                    <div class="col-12 col-md-2 border-end">
                        <div class="card-body">
                            ...
                            <div class="list-group list-group-transparent">
                                {{-- Nav links --}}
                                @include('user.pages.edit-store.include.nav-link', ['link' => 'products'])
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="productName" name="product_name" placeholder="{{ __('Product Name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="productShortDescription" name="product_short_description" placeholder="{{ __('Product Short Description') }}" required>
                                </div>
                            </div>
                            {{-- Product Description --}}
                            <div class="col-md-12 col-xl-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control product-description" id="productDescription"
                                        name="product_description" placeholder="{{ __('Product Description') }}" required></textarea>
                                </div>
                            </div>
                            {{-- Regular Price --}}
                            <div class="col-md-4 col-xl-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-xl-12">
                                <div class="mb-3">
                                    <label for="productDescription"
                                        class="form-label required">{{ __('Product Description') }}</label>
                                    <textarea class="form-control product-description" id="editProductDescription"
