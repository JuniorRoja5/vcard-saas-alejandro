                                ...
                                <div class="row">
                                    <div class="col-xl-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-xl-3">
                                                <div class="mb-3">
                                                    <label class="form-label required">{{ __('Trial period') }}</label>
                                                    <input type="number" class="form-control" name="trial_period"
                                                        min="0" max="9999" placeholder="{{ __('Trial period') }}"
                                                        value="{{ $plan_details->trial }}" required>
                                                    <small class="text-muted">{{ __('Setting the value to 0 disables the trial period, meaning users will not receive any free trial access.') }} </small>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <input type="number" class="form-control" name="storage" min="0" max="999" placeholder="{{ __('Storage') }}" value="{{ $plan_details->storage }}" required>
                                                            <span class="input-group-text">{{ __('MB per user') }}</span>
                                                        </div>
