                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="trial_period"
                                                        min="0" max="9999" placeholder="{{ __('Trial period') }}" value="{{ old('trial_period') }}"
                                                        required>
                                                ...
                                                <div class="col-md-3 col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            <input type="number" class="form-control" name="storage" min="0" max="999" placeholder="{{ __('Storage') }}" value="{{ old('storage') }}" required>
