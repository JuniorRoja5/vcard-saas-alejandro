                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="category_name" id="category_name" maxlength="200" value="{{ $blogCategoryDetails->blog_category_title }}" placeholder="{{ __('Eg: Blog title') }}" required>
                                            </div>
                                        </div>
