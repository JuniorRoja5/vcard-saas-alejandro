                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="blog_name" id="blog_name" maxlength="200" placeholder="{{ __('Eg: Blog title') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="short_description" id="short_description" placeholder="{{ __('Eg: Blog title') }}" cols="30" rows="3" required></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="long_description" id="long_description" cols="30" rows="5" class="form-control" placeholder="{{ __('Description') }}"></textarea>
                                                </div>
                                            </div>
