                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nfc_card_name" id="nfc_card_name" class="form-control" minlength="3" maxlength="999" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group">
                                                ...
                                                <textarea name="nfc_card_description" id="nfc_card_description" class="form-control" minlength="5" maxlength="4999" required></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
