                                            ...
                                            <div class="row">                                             
                                                ...
                                                <div class="col-md-6 col-xl-6 mb-2 d-none">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="tiny_api_key" value="{{ $config[39]->config_value }}" placeholder="{{ __('Tiny Cloud API Key (Eg: ytf5**************************)') }}"
                                                            required>
                                    ...
                                    <form action="{{ route('admin.change.website.settings') }}" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 mb-3">
                                                <h2 class="page-title">{{ __('Additional Settings') }}</h2>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control code" name="custom_css" rows="4"
                                                        ...
                                                        placeholder="{{ __('Custom CSS') }}">{{ $settings->custom_css }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control code" name="custom_js" rows="4"
                                                        data-bs-toggle="autosize" maxlength="25000" style="border-top-right-radius: 7px !important; border-bottom-right-radius: 7px !important;"
                                                        placeholder="{{ __('Custom JS') }}">{{ $settings->custom_scripts }}</textarea>
                                                </div>
                                            </div>
