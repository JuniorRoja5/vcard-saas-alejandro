                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xl-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="description" value="{{ old('description') ?? $couponDetails->coupon_desc }}" placeholder="{{ __('Description') }}" autocomplete="description" autofocus>
                                            </div>
                                        </div>
